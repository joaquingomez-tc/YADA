  ...
  private static final String SCINAMIC_SEARCH = "SCINAMIC/search";
    ...
    catch (YADAException e2)
    {
      ...
      e2.printStackTrace();
        ...
        catch (YADAQueryConfigurationException | YADAResourceException | YADAConnectionException | YADAFinderException | YADAUnsupportedAdaptorException | YADARequestException | YADAAdaptorException | YADAParserException  e1)
        {
